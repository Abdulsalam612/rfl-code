...
void onConnectedController(ControllerPtr ctl) {
  ...
  if (myController == nullptr) {
    ...
    if(ALLOW_ANY_CONTROLLER_TO_CONNECT){
      ...
      myController->setColorLED(/*Red*/0, /*Green*/255, /*Blue*/0);
      ...
      ctl->setRumble(/*force*/128, /*duration*/528);
    }
...
void processControllerInputs(ControllerPtr myController) {
    ...
    leftThrottle = map(leftThrottle, /*Min axis value*/-506, /*Max axis value*/512, -100, 100);
    rightThrottle = map(rightThrottle, /*Min axis value*/-506, /*Max axis value*/512, -100, 100);
